...
//                .defaultTools(new SyncMcpToolCallbackProvider(sseMcpClient01(), sseMcpClient02()))
        ...
        String userInput = "生成一篇文章" + content;
        System.out.println("\n>>> QUESTION: " + userInput);
    ...
    public McpSyncClient stdioMcpClient() {
        ...
        var stdioParams = ServerParameters.builder(
                        "D:\\deeping study\\node\\npx.cmd")
                .args( "-y",
                        "g-search-mcp")
                .build();
    ...
    public McpSyncClient sseMcpClient01() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://0.0.0.0:8102").build();
    ...
    public McpSyncClient sseMcpClient02() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://0.0.0.0:8101").build();
