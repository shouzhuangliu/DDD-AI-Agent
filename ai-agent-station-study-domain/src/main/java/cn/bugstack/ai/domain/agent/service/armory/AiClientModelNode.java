...
public class AiClientModelNode extends AbstractArmorySupport  {
    ...
    protected String doApply(ArmoryCommandEntity requestParameter, DefaultArmoryStrategyFactory.DynamicContext dynamicContext) throws Exception {
        ...
        for(AiClientModelVO modelVO : aiClientModelList) {
            ...
            String apiBeanName = AiAgentEnumVO.AI_CLIENT_API.getBeanName(modelVO.getApiId());
            if (!applicationContext.containsBean(apiBeanName)) {
                log.warn("跳过不可用模型，modelId={}，apiId={}", modelVO.getModelId(), modelVO.getApiId());
                continue;
            }
            ...
            for (String toolMcpId : modelVO.getToolMcpIds()) {
                ...
                if (null == mcpSyncClient) {
                    throw new RuntimeException("mode 2 tool mcp is null");
                }
