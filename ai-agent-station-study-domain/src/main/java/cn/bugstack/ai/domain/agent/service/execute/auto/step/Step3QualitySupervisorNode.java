...
public class Step3QualitySupervisorNode extends AbstractExecuteSupport {
    ...
    protected String doApply(ExecuteCommandEntity requestParameter, DefaultAutoAgentExecuteStrategyFactory.DynamicContext dynamicContext) throws Exception {
        ...
        // [状态机] 推进状态
        dynamicContext.setCurrentState(AutoAgentStateEnum.SUPERVISE.next(dynamicContext));
    ...
    public StrategyHandler<ExecuteCommandEntity, DefaultAutoAgentExecuteStrategyFactory.DynamicContext, String> get(ExecuteCommandEntity requestParameter, DefaultAutoAgentExecuteStrategyFactory.DynamicContext dynamicContext) throws Exception {
        // [状态机] 按当前状态路由
        String nodeName = dynamicContext.getCurrentState().nodeName();
        if (nodeName == null) {
            return getBean("step4LogExecutionSummaryNode");
        }
        return getBean(nodeName);
    }
